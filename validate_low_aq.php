...
?>
<h1> Validate Low AQ Infomation Display </h1>
<table border="1">
	<tr>
		<th>Id</th>
		<th>validatedtype</th>
...
<?php
	...
	$sql = "select * from `allagent_input` where leadstatus like '%validated low aq%'";
...
?>
		<tr>
			...
			<td>
				<audio controls>
				 <iframe width='100' height="100" src="audio/<?php echo $row[file];?>"></iframe>
				 </audio>
			</td>


			<td><?php echo $row['qa_feedback'];?></td>
			<td><a href="qa_feedbackEdit.php?edit=<?php echo $row['id'];?>">Edit</a></td>
